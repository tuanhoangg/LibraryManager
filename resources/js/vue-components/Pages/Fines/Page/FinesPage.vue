                ...
                <div class="my-3 mx-3 row col-md-12">
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select" v-model="status">
                            ...
                            <option v-for="(status, key) in JSON.parse(filterStatus)" :value="key">
                                {{status.label}}
                            </option>
                        </select>
                    </div>
                ...
                <tbody>
                    ...
                    <tr v-for="(borrow, index) in lateReturn">
                        ...
                        <td class="text-center">
                            <a v-if="borrow.status == 0" href="#" @click="payment(borrow.id)"  data-toggle="modal" data-target="#cancel-borrow-status-modal"  
...
export default {
    ...
    methods: {
        async loadItems() {
            ...
            const response = await axios.get(`fines/api/get-fines-list?limit=${this.perPage}&offset=${(this.currentPage - 1) * this.perPage}&searchValue=${this.searchValue}
